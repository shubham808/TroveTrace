...
$temp=mysqli_fetch_row($qry);
                                           ...
                                           if(($date==23&&$month==10&&$year==2016&&$min>=00&&$sec>=0&&$hour>=22)||($date==10&&$month==11&&$year==2016))
        									...
        									$flag=2;
                                                    ...
                                                    //               $flag=1;
																	if($flag==0)
                                                                             { ?>
                                           <center><a href="#" class="button button-big button-icon button-icon-check">Hold your horses till 10:00PM 23/10/2016 </a></center>
                                             <?php }
                                            else if($flag==2)
	...
	<center><a href="<?php echo $urll?>" class="button button-big button-icon button-icon-check">Play Game!</a></center> <!--sends to current level in game-->
            <?php } }else {?>
									...
									<center><a href="http://www.infotsav.com/" color="#ffffff"><font color="white">Register Here for Infotsav</font></a></center>
									<?php }?>
								</div>
